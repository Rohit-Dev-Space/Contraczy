...
export default function Challenges() {
    ...
    const gridItems = [
        ...
        },
        {
            ...
            painContent: "SpotDraft is often optimized for legal users, which can make it overwhelming for sales, procurement, and operations teams. Navigation and simples tasks become time-consuming, reducing overall team productivity.",
                                ...
                                <PixelTransition
                                    ...
                                    secondContent={
                                        <div className={`flex w-full h-full flex-col gap-2 p-5`} style={{ background: info.bgGradient }}>
                                            <span className="w-fit text-xs font-semibold px-3 py-1 rounded-full bg-green-500/20 text-green-300 border border-green-500/30">
                                                Contractzy Solution
                                            </span>
                                            <h2
